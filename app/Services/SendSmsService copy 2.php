...
class SendSmsService
{
    ...
    //     public function africaIsTalking()
    //     {
    //         $client = new Client();
    //         $headers = [
    //             'Accept' => 'application/json',
    //             'Content-Type' => 'application/json',
    //             'apiKey' => 'atsk_011add9653c4b48ec80b59bc746ac9604018e8f5dca861c0ade13c1916d6e491369d02f3'
    //         ];
    //         $body = '{
    //   "username": "SmsTrix",
    //   "phoneNumbers": [
    ...
    //   ]
    // }';
    //         $request = new Request('POST', 'https://api.africastalking.com/version1/messaging/bulk', $headers, $body);
    //         $res = $client->sendAsync($request)->wait();
    //         echo $res->getBody();
    //     }

    public function africaIsTalking($senderId, array $phones)
    {
