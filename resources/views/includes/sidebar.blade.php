        ...
        <div class="p-3 flex-1 overflow-y-auto">
            <ul class="pt-12 space-y-6" x-data="{ openMenu: null }">
                <div class=space-y-4>
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}" wire:navigate.hover @click.prevent="activeLink = 'bulk'"
                ...
                <div class="space-y-4">
                    ...
                    <li>
                        ...
                        <ul x-show="openMenu === 'topup'" x-transition:enter="transition ease-out duration-500"
                            ...
                            <li><a href="{{ route('payment.bank') }}" wire:navigate.hover
                                    ...
                                    Bank Transfer</a></li>
                            <li><a href="{{ route('payment.paystack') }}" wire:navigate.hover
                                    class="text-textPrimary font-light text-sm flex items-center transition-all duration-500 hover:translate-x-2 hover:text-blue hover:font-medium">Via
                                    Card</a></li>
                ...
                <div class="space-y-4">
                    ...
                    <li>
                        <a href="{{ route('single') }}" wire:navigate.hover @click.prevent="activeLink = 'single'"
                    ...
                    <li>
                        <a href="{{ route('bulk') }}" wire:navigate.hover @click.prevent="activeLink = 'bulk'"
                            :class="{ 'text-blue font-semibold': activeLink === 'bulk', 'text-gray': activeLink !== 'bulk' }"
                            class="text-textPrimary font-light text-base flex items-center transition-all duration-500 hover:translate-x-2 hover:text-blue hover:font-medium">
                            <span><i class="fa-solid fa-mobile-screen-button mr-2"></i></span>
                            Bulk
                ...
                <div class="space-y-4">
                    ...
                    <li>
                        <a href="{{ route('schedule') }}" wire:navigate.hover @click.prevent="activeLink = 'bulk'"
                            :class="{ 'text-blue font-semibold': activeLink === 'bulk', 'text-gray': activeLink !== 'bulk' }"
                            class="text-textPrimary font-light text-base flex items-center transition-all duration-500 hover:translate-x-2 hover:text-blue hover:font-medium">
                            <span><i class="fa-solid fa-mobile-screen-button mr-2"></i></span>
                            Schedule SMS
                ...
                <div class=space-y-4>
                    ...
                    <li>
                        <a href="{{ route('message') }}" wire:navigate.hover @click.prevent="activeLink = 'bulk'"
                            :class="{ 'text-blue font-semibold': activeLink === 'bulk', 'text-gray': activeLink !== 'bulk' }"
                            class="text-textPrimary font-light text-base flex items-center transition-all duration-500 hover:translate-x-2 hover:text-blue hover:font-medium">
                            <span><i class="fa-solid fa-mobile-screen-button mr-2"></i></span>
                            Messages History
                    ...
                    <li>
                        <a href="{{ route('payment.history') }}" wire:navigate.hover
                ...
                <div class=space-y-4>
                    ...
                    <li>
                        <a href="{{ route('profile') }}" wire:navigate.hover @click.prevent="activeLink = 'single'"
                            :class="{ 'text-blue font-semibold': activeLink === 'single', 'text-gray': activeLink !== 'single' }"
                            class="text-textPrimary font-light text-base flex items-center transition-all duration-500 hover:translate-x-2 hover:text-blue hover:font-medium">
                            <span><i class="fa-solid fa-mobile-screen-button mr-2"></i></span>
                            Profile
