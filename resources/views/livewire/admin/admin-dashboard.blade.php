            ...
            <div class="flex justify-between mb-4">
                ...
                <div>
                    <div class="flex items-center mb-1">
                        ...
                        @else
                            <div
                                class="text-2xl font-semibold {{ $dashboardBalance < 500 ? 'text-red-600 animate-pulse' : 'text-green-600' }}">
                                ₦ {{ number_format($dashboardBalance, 2, '.', ',') }}
                            </div>
                        @endif
                    </div>
            ...
            <div class="flex justify-between mb-4">
                <div>
                    <div class="flex items-center mb-1">
                        ...
                        @else
                            <div class="text-2xl font-semibold">{{ $paymentCount }}</div>
                        @endif
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed">
                        ...
                        <tbody>
                            ...
                            @elseif ($allAdminMessage->isEmpty())
