<div>
    ...
    <div class="flex flex-col bg-white rounded-lg pt-8 mt-8 px-6 space-y-2" wire:init="getAdmins">
        <div class="flex justify-between items-center">
            <h3 class="font-bold text-2xl">All Admins</h3>
            <button class="bg-blue py-1 px-4 text-white rounded-lg cursor-pointer text-sm">Add Admin</button>
        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed">
                        ...
                        @else
                            <tbody>
                                ...
                                @if (!empty($allAdmins) && count($allAdmins) > 0)
