<div wire:poll.2000ms="getAllUserBalance" wire:init="getAllUserBalance">
    ...
    <div x-data="{ open: false, accountBalance: 1000 }">
        <div class="flex items-end justify-between relative">
            ...
            <div class="flex items-center gap-8">
                ...
                <div x-show="open"
                    class="absolute right-0 mt-48 p-4 w-48 bg-white shadow-lg rounded-lg overflow-hidden z-10 dropdown"
