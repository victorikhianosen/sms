                                        ...
                                        <tr class="odd:bg-white even:bg-gray-100">
                                            ...
                                            <td class="px-4 py-4 whitespace-normal flex items-center gap-2">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if (\Illuminate\Support\Facades\Blade::check('adminOrSuperAdmin')): ?>
                                                    <button wire:click.prevent="deleteAdmin(<?php echo e($item->id); ?>)"
...
<?php /**PATH C:\Users\HP\Documents\GGT\sms\resources\views/livewire/admin/admin-list.blade.php ENDPATH**/ ?>