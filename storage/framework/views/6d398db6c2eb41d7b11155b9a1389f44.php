<div x-data="{ showAddModal: <?php if ((object) ('showModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'->value()); ?>')<?php echo e('showModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'); ?>')<?php endif; ?> }"> <!-- Sync Alpine with Livewire -->
    ...
    <div class="pt-4 pb-10 px-6 flex justify-between items-center">
        ...
        <button type="button"
            ...
            @click="showAddModal = true"> <!-- Open modal with Alpine -->
            Add Group
        </button>
    </div>
    ...
    <!-- Add Modal -->
    <div x-show="showAddModal" x-transition @click.self="showAddModal = false"
        ...
        <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-8 relative">
            <div class="flex items-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320.591 320.591"
                    ...
                    <path
                        d="M19.612 0L0 19.612 140.683 160.3 0 300.979l19.612 19.612 140.683-140.683 140.683 140.683 19.612-19.612-140.683-140.679 140.683-140.683L300.979 0 160.295 140.683 19.612 0z" />
                </svg>
            </div>
