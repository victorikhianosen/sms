            ...
            <ul class="pt-12 space-y-6" x-data="{ openMenu: null }">
                ...
                <div class=space-y-6>
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('adminOrSuperAdmin')): ?>
                        <li>
                            <a href="<?php echo e(route('admin.ledgers')); ?>" wire:navigate.hover
                                :class="{ 'text-blue font-semibold': activeLink === 'single', 'text-gray': activeLink !== 'single' }"
                                class="text-textPrimary font-light text-base flex items-center transition-all duration-500 hover:translate-x-2 hover:text-blue hover:font-medium">
                                <span><i class="fa-solid fa-mobile-screen-button mr-2"></i></span>
                                Ledger Accounts
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.transactions')); ?>" wire:navigate.hover
                                :class="{ 'text-blue font-semibold': activeLink === 'single', 'text-gray': activeLink !== 'single' }"
                                class="text-textPrimary font-light text-base flex items-center transition-all duration-500 hover:translate-x-2 hover:text-blue hover:font-medium">
                                <span><i class="fa-solid fa-mobile-screen-button mr-2"></i></span>
                                Transactions
                        ...
                        <li>
                            <a href="<?php echo e(route('admin.exchange')); ?>" wire:navigate.hover
                                :class="{ 'text-blue font-semibold': activeLink === 'single', 'text-gray': activeLink !== 'single' }"
                                class="text-textPrimary font-light text-base flex items-center transition-all duration-500 hover:translate-x-2 hover:text-blue hover:font-medium">
                                <span><i class="fa-solid fa-mobile-screen-button mr-2"></i></span>
                                Exchange Accounts
                ...
                <div class=space-y-4>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.providers')); ?>"
                            :class="{ 'text-blue font-semibold': activeLink === 'single', 'text-gray': activeLink !== 'single' }"
                            class="text-textPrimary font-light text-base flex items-center transition-all duration-500 hover:translate-x-2 hover:text-blue hover:font-medium">
                            <span><i class="fa-solid fa-mobile-screen-button mr-2"></i></span>
                            Providers
...
<?php /**PATH /home/victor/Documents/GGT/sms/resources/views/includes/admin/sidebar.blade.php ENDPATH**/ ?>